...
namespace OurApp.WinUI
{
    public sealed partial class MainWindow : Window
    {
        ...
        public MainWindow()
        {
            string connectionString = "Data Source=DESKTOP-D8Q1P5P\\SQLEXPRESS;Initial Catalog=iss_project;Integrated Security=True;Encrypt=True;Trust Server Certificate=True";
